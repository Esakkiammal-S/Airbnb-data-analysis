...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    filename = fl.name
    st.write(filename)
    df = pd.read_csv("Airbnb NYC.csv", encoding="ISO-8859-1")
 else:
...
with col1:
        image1 = Image.open(r"D:\AIRBNBANALYSIS\aero.jpg")
        st.image(image1, width=300)
        
with col2:
    col2.subheader("NAME : Esakki")
    col2.subheader("EMAIL: psesakki24@gmail.com")
    col2.subheader("BATCH : MDTE005")
